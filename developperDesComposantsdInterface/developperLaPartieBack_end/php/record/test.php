...
<div class="container-fluid">
    ...
    <div class="row align-items-end">
        ...
        <img src="./src/img/jarditou_logo.jpg" alt="jarditou_logo" title="jarditou_logo"
    ...
    <div class="row">
        ...
        <img src="./src/img/promotion.jpg" alt="promotion" title="promotion" class="col-12">
    ...
    <div class="container-fluid">
        <div class="row no-gutter">
            ...
            <section class="col-lg-8">
                ...
                <article>
                    <h2>L'entreprise</h2>
                    <p>Notre entreprise familiale met tout son savoir-faire à votre disposition du jardin et du paysagisme.</p>
            ...
            <section class="col-lg-4 bg-warning font-weight-bold text-center">
                <div>
                    <p>[COLONNE DROITE]</p>
                </div>
            </section>
