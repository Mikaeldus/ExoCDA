...
CREATE TABLE ARTICLES_A_COMMANDER(
    ...
    CODART CHAR(4),
    DAT DATETIME NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp(),
    QTE DECIMAL(10,2)
);

ALTER TABLE ARTICLES_A_COMMANDER
ADD CONSTRAINT ARTICLES_A_COMMANDER_produit_FK FOREIGN KEY (codart) REFERENCES produit(codart);
